...
def main(optimizers):
    ...
    for train_step in train_steps:
        ...
        printable_accuracy = sess.run(accuracy, feed_dict={x: mnist.test.images, y_: mnist.test.labels})
        print('Optimizer: ' + str(train_step.name) + ', Accuracy: ' + str(printable_accuracy))
